...
const PaymentConfirmation = () => {
  ...
  return (
    <ScreenBoiler
      ...
      <CustomText style={styles.header}>Payment Confirmation</CustomText>
      <View
        style={[
          styles.mainScreen,
          {
        ...
        <View style={styles.pay_con}>
          ...
          <View style={styles.text_con}>
            ...
            <CustomText style={styles.text_tal}>id</CustomText>
            <CustomText style={styles.text_tal}>9388295</CustomText>
          </View>

       
              <View style={styles.sec_row}>
            <CustomText style={styles.text_tal}>payment date</CustomText>
            <CustomText style={styles.text_tal}>$350.00</CustomText>
          </View>
              <View style={styles.sec_row}>
            <CustomText style={styles.text_tal}>card</CustomText>
            <CustomText style={styles.text_tal}>**** 2345</CustomText>
          </View>
              <View style={styles.sec_row}>
            <CustomText style={styles.text_tal}>price</CustomText>
            <CustomText style={styles.text_tal}>$350.00</CustomText>
          </View>
        </View>
        <CustomButton
