    ...
    const appointments = [
        {
            ...
            description: 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Maecenas Tempor Lacus Eros, At Scelerisque Arcu Feugiat Ut. Praesent Tempus Ipsum Leo, A Gravida Metus Luctus Et.',
            ...
            <View style={{
                ...
                <ImageBackground
                    ...
                    <CustomText style={styles.txt}>
                        At Vitality Access, We Believe Optimal Wellness Should Be Within Everyone's Reach. Our Curated Membership Unlocks Exclusive Pricing And Access To The Most Advanced Holistic And Regenerative Treatments Available Today.
                    </CustomText>
                </ImageBackground>
                <View style={styles.row_view}>
                    <CustomText isBold style={[styles.h1, { color: Color.btntextColor }]}>Redeemable Vouchers</CustomText>
                ...
                />
                <View style={[styles.row_view,]}>
                    <CustomText isBold style={[styles.h1, { color: Color.btntextColor }]}>Discount Codes</CustomText>
                    <CustomText style={styles.text}>View All</CustomText>
                </View>
                <FlatList
                    data={appointments}
