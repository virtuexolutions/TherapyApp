    ...
    return (
        <SafeAreaView style={styles.main_con}>
            ...
            <View style={styles.main_view}>
                <SearchbarComponent SearchStyle={{ backgroundColor: Color.themeColor }} isLeftIcon name={'search'} as={EvilIcons} size={moderateScale(24, 0.6)} color={Color.white} textColor={Color.white} placeHolderColor={Color.lightGrey} placeholderName={'Search Saved Clinics...'} />
                <FlatList
                    data={clinics}
